class File {
    ...
    get filename() {
        let result = this._fullName.split(".")
    ...
    gets() {
        if (this.counts === 0) {
            this.strArr = [...this.contents.split("\n")]
        }
        this.counts++
        return this.strArr[this.counts - 1]
    }

    getc() {
        this.countc++
        this.charArr = this.contents.split("")
        return this.charArr[this.countc - 1]
    }
}
...
//
// let file2 = new File("class.phptester.php", "<?php /* Some PHP code here */ ?>");
...
//     Test.assertEquals(example.gets(), "This is an example file provided to you by the Kata author");
//     Test.assertEquals(example.gets(), "This example file is used as an example test case.");
...
//     Test.assertEquals(example.getc(), undefined);
//   });
//   it("should work for my custom test cases", function () {
//     // TODO: Create a working solution by implementing the TDD cycle: write a failing test, write code to pass it, repeat
//   });
// });
