function isSantaClausable(obj) {
    ...
    if  ( (obj.name ==="Santa" || obj.getOwnPropertyNames().length === 0) ||
        (obj.hasOwnProperty("sayHoHoHo") || obj.hasOwnProperty("say_ho_ho_ho"))
        && (obj.hasOwnProperty("distributeGifts") ||obj.hasOwnProperty("distribute_gifts") )
        && (obj.hasOwnProperty("distributeGifts") || obj.hasOwnProperty("go_down_the_chimney"))
    )
    {
        return true
    } else {
