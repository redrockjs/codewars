...
//
// Aside: Operators?
// In JavaScript, perhaps no operator is as complicated as new. "Wait; new is an operator?" Yep; an operator is
// something that operates on one or more operands and evaluates to a result. Binary operators like + and !== operate on two operands:
//
// 5 + 5 evaluates to 10
// {} !== [] evaluates to true
...
// Ultimately operators are functions with different syntax. They take inputs/operands and return/evaluate to
// something. In fact, some JS operators can be re-written as functions.
//
// New
...
// If the return value of Constructor is an object (including arrays, functions, dates, regexes, etc.) the
// operation evaluates to that object
